            ...
            <table class="datatable table table-stripped">
                ...
                <tbody>
                    ...
                    if(isset($_REQUEST['srh-btn'])) {
                        ...
                        $search_query = mysqli_query($connection, "SELECT tbl_employee.first_name, tbl_employee.last_name, tbl_employee.department, tbl_attendance.date, tbl_attendance.shift, tbl_attendance.location, tbl_attendance.check_in, tbl_attendance.message, tbl_attendance.in_status, tbl_attendance.check_out, tbl_attendance.out_status FROM tbl_employee INNER JOIN tbl_attendance ON tbl_attendance.employee_id=tbl_employee.employee_id WHERE tbl_attendance.department='$dept' AND DATE(tbl_attendance.date) BETWEEN '$from_date' AND '$to_date'");
